...
import { createAffirmation, getAffirmationByDate } from '../db/queries/affirmations';
import { createFeelings, getFeelingsByDate } from '../db/queries/feelings';
import { createMentalHealth, getMentalHealthByDate } from '../db/queries/mentalhealth';
import { createSubstances, getMySubstances, getSubstancesByDate } from '../db/queries/substances';
...
export const appRouter = t.router({
  ...
  affirmation: t.router({
    ...
    .mutation((opts) => {
      return createAffirmation(opts.input.date, opts.input.entryId, opts.input.content)}),
    one: t.procedure
    .input(
      z.object({
        date: z.string(),
  ...
  feelings: t.router({
    ...
    .mutation((opts) => {
      return createFeelings(opts.input.date, opts.input.entryId, opts.input.content)}),
    one: t.procedure
    .input(
      z.object({
        date: z.string(),
  ...
  mentalHealth: t.router({
    ...
    .mutation((opts) => {
      return createMentalHealth(opts.input.date, opts.input.entryId, opts.input.content)}),
    one: t.procedure
    .input(
      z.object({
        date: z.string(),
  ...
  substances: t.router({
    ...
    .mutation((opts) => {
      return createSubstances(opts.input.date, opts.input.entryId, opts.input.name, opts.input.amount)}),
    one: t.procedure
    .input(
      z.object({
        date: z.string(),
  ...
  sleep: t.router({
    ...
    .mutation((opts) => {
      return createSleep(opts.input.date, opts.input.entryId, opts.input.bedTime, opts.input.wakeUpTime, opts.input.sleepQuality)}),
    one: t.procedure
    .input(
      z.object({
        date: z.string(),
  ...
  exercise: t.router({
    ...
    .mutation((opts) => {
      return createExercise(opts.input.date, opts.input.entryId, opts.input.content)}),
    one: t.procedure
    .input(
      z.object({
        date: z.string(),
  ...
  question: t.router({
    ...
    .mutation((opts) => {
      return createQuestion(opts.input.date, opts.input.entryId, opts.input.question, opts.input.answer)}),
    one: t.procedure
    .input(
      z.object({
        date: z.string(),
  ...
  content: t.router({
    ...
    .mutation((opts) => {
      return createContent(opts.input.date, opts.input.entryId, opts.input.content)}),
    one: t.procedure
    .input(
      z.object({
        date: z.string(),
