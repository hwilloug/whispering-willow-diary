    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-purple-200"
        ),
        day_range_end: "day-range-end",
        day_selected: "bg-purple-500 text-white",
        day_today: "bg-purple-300 text-neutral-900",
        day_outside:
      ...
      components={{
        ...
        DayContent: ({ ...props }) => (
          <div {...props} className="">
            <div
              className={`${dotValues.includes(format(props.date, "yyyy-MM-dd")) ? "border border-[--primary-dark] rounded-full p-1" : ""}`}
            >
              {format(props.date, "d")}
            </div>
          </div>
